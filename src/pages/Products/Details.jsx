    ...
    <Card title={`Product ${data.id}`}>
      ...
      <Modal open={confirm} title="Confirm delete" onClose={() => setConfirm(false)}>
        ...
        <div className="mt-3 flex justify-end gap-2">
          ...
          <Button variant="danger" loading={removing} onClick={async () => { await remove(Number(id)); navigate('/products') }}>Delete</Button>
        </div>
      </Modal>
    </Card>
  )
